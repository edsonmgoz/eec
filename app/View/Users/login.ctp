    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          <?php echo $this->Html->image('image_1.jpg', array('alt' => 'imagen uno', 'class' => 'img-circle', 'style' => 'width: 140px; height: 140px;')); ?>
          <h2>Esamblaje</h2>
        ...
        <div class="col-lg-4">
          <?php echo $this->Html->image('image_2.jpg', array('alt' => 'imagen uno', 'class' => 'img-circle', 'style' => 'width: 140px; height: 140px;')); ?>
          <h2>Pedidos</h2>
        ...
        <div class="col-lg-4">
          <?php echo $this->Html->image('image_3.jpg', array('alt' => 'imagen uno', 'class' => 'img-circle', 'style' => 'width: 140px; height: 140px;')); ?>
          <h2>Cotizaciones</h2>
