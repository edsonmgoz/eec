<div class="row">
	<div class="col-md-6">
		<div class="page-header">
			<h2><?php echo __('Editar venta'); ?></h2>
		</div>
		<?php echo $this->Form->create('Sale', array('role' => 'form')); ?>
			...
			<p>
				<?php echo $this->Form->end(array('label' => 'Editar venta', 'class' =>'btn btn-success')); ?>
			</p>
			...
			<div class="btn-group">
			  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
				...
				<ul class="dropdown-menu" role="menu">
					<li><?php echo $this->Form->postLink(__('Cancelar'), array('action' => 'delete', $this->Form->value('Sale.id')), array(), __('Estas seguro de cancelar la venta ?')); ?></li>
