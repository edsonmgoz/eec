<div class="col-md-12">
	...
	<div class="table-responsive">
		...
		<tr>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('Consultar compra'), array('action' => 'process', $shopping['Shopping']['id']), array('class' => 'btn btn-sm btn-info')); ?>
				<?php echo $this->Html->link(__('Comprar'), array('action' => 'process', $shopping['Shopping']['id']), array('class' => 'btn btn-sm btn-success')); ?>
			</td>
		</tr>
	<?php endforeach; ?>
		</tbody>
